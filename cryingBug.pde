...
int count = 1000;  // максимальное количество букашек
...
void draw()
{
  ...
  // раскомментить следующую строчку, для сохранения скриншотов
  //if( frameCount % 16 == 0 ) { saveFrame(fileN+".png"); fileN++;  }
}
